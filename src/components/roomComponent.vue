                 ...
                 if(this.screenActive){
                   alert('you can not share screen');
                     ...
                     localStorage.setItem('friendId', friendId);
                       // this.$socket.emit('screenUrl',{userId:this.c_user._id, startScreen: this.c_user._id, friendId:this.singleRoom, viewerUrl:'https://turn.peekvideochat.com/sViewer.html'} );
