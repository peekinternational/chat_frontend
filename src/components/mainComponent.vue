              ...
              <div class="col col-md-12" style="margin-top: 35px;">
                ...
                <div class="col col-md-8" id="startMeeting" style="max-width: 64.66667%;display:none" >
                         ...
                         <div class="col col-md-12" style="background-color:white;margin-bottom: 12px;">
                          <div class="row" style="padding-top: 13px;padding-bottom: 9px;">
                           ...
                           <div class="col col-md-10 url_custom" style="border-left: 1px solid gainsboro;height: 15px;">
                             <p>URL: <span> https://turn.peekvideochat.com/meeting?meetingId={{singleMeeting.meeting_id}}</span></p>
                           </div>
                           <div class="col col-md-1">
                           	 <a href="#" @click="copymsg('https://turn.peekvideochat.com/meeting?meetingId='+singleMeeting.meeting_id)" v-clipboard:copy="messagecopy" v-clipboard:success="onCopy" v-clipboard:error="onError">
                         ...
                         <div class="col col-md-12 meetingTopic" v-if="singleMeeting.recorded_file" style="margin-bottom: 40px;">
                          <div class="row" style="padding-top: 14px;padding-bottom: 9px;">
                            ...
                            <div class="col col-md-9" style="border-left: 1px solid gainsboro;height: 15px; display: flex;">
                             <p>{{ $t("Record") }}</p>
                             <a style="margin-left: 5px" :href=" 'https://turn.peekvideochat.com:22000/images/chatImages/' + singleMeeting.recorded_file"> {{singleMeeting.recorded_file}} </a>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="col-md-3" style="margin-top: 17px;">
                    <a href="#" v-if="singleMeeting.createdBy == current_User._id" @click="copymsg('Meeting URL=https://turn.peekvideochat.com/meeting?meetingId='+singleMeeting.meeting_id+', Meeting Id='+singleMeeting.meeting_id+', Meeting Password='+singleMeeting.meeting_password)" v-clipboard:copy="messagecopy" v-clipboard:success="onCopy" v-clipboard:error="onError">
                     {{ $t('CopyMeeting') }}</a>
                  </div>
                      <div class="col col-md-5">
...
var friendId=this.oncallFriend._id;
 ...
 // this.$socket.emit('screenUrl',{userId:this.c_user._id, startScreen: this.c_user._id, friendId:this.oncallFriend._id, viewerUrl:'https://turn.peekvideochat.com/sViewer.html'} );
